...
//    void search(QString query, int page, int type) override{
//        Q_UNUSED(type);
...
//    void search(std::string url,bool emitFetchedMore=false) {
//        m_widgetSearched=false;
...
//        if(emitFetchedMore){
//            emit fetchedMore (animes);
//        }else{
//            emit searchFinished(animes);
//        }
//    };

//    void popular(int page,int type)override{
//        Q_UNUSED(type);
//        return widgetSearch("trending",page);
//    };

//    void latest(int page,int type)override{
//        Q_UNUSED(type);
//        return widgetSearch ("updated-sub",page);
//    };

//    void widgetSearch(std::string path,int page,bool emitFetchedMore=false)
//    {
...
//        auto episodesUrl=hostUrl().toStdString ()+ "/ajax/episode/list/" + dataId+"?vrf="+encodeVrf (dataId,keys);
...
//            }
//            episode.link = hostUrl().toStdString ()+ "/ajax/server/list/" + ids + "?vrf=" + encodeVrf(ids,keys);
...
//    //        bool loadSource(MediaResponseItem* item)override;
...
//    //            auto episodeBody= GlobalObjects::client->get (serverDataUrl)
//    //                                   ->json ()["result"];//todo add headers
//    //            nlohmann::json skip_data = episodeBody["skip_data"];
//    //            if(!skip_data.empty ()){
//    //                server->skipData = new SkipData;
//    //                server->skipData->introBegin=skip_data["intro_begin"].get<int> ();
//    //                server->skipData->introBegin=skip_data["intro_end"].get<int> ();
//    //                server->skipData->introBegin=skip_data["outro_begin"].get<int> ();
//    //                server->skipData->introBegin=skip_data["outro_end"].get<int> ();
//    //            }
//    //            std::string url=decodeVrf(episodeBody["url"].get<std::string>(),keys["decipher"].get<std::string> ());
...
//        if(m_widgetSearched){
//            widgetSearch (m_lastSearch,++m_currentPage,true);
//        }else{
//            search ("https://9anime.pl/filter?keyword="+m_lastSearch+"&page="+std::to_string (++m_currentPage),true);
//        }
