// Adapted from https://raw.githubusercontent.com/ZSAIm/iqiyi-parser/master/js/tencent.js
...
var mdl_dir = path.dirname(__filename);
var ckey_wasm = path.join(mdl_dir, 'ckey.wasm');  // WebAssembly code from TencentVideo

const fs = require('fs');
var wasm_data = fs.readFileSync(ckey_wasm);
